...
export default function VisionSection() {
  return (
    <div className="flex flex-col gap-10 pb-28 md:flex-row md:justify-between">
      <div className="flex-1 border-[1px] border-[#1E1F3F] rounded-4xl min-h-[300px] md:min-h-[480px]">
        <div className="w-full h-full flex flex-col gap-4 justify-between py-6 px-6 text-center md:text-left md:px-10">
      ...
      <div className="flex-1 bg-[#1E1F3F] rounded-4xl h-[300px] md:h-[480px]" />
    </div>
  );
}
